...
GENERIC_FUNCTION_SLOTS = [GENERIC_FUNCTION_NAME, GENERIC_FUNCTION_ARGS, GENERIC_FUNCTION_METHODS, GENERIC_FUNCTION_CACHED_EFFECTIVE_METHODS]
...
function call_effective_method(generic_f, args)
    ...
    println(applicable_method_stack.args)
    readline()
...
global print_object = new(GenericFunction, name=:print_object, args=[:obj, :io])
